...
| --- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
|     | ![Bild](../images/05_Timer/Intel_PolledMethod.png)<!-- style="width: 75%; max-width: 1000px" --> [^1] | ![Bild](../images/05_Timer/Intel_Interrupt.png)<!-- style="width: 75%; max-width: 1000px" --> [^1] |
